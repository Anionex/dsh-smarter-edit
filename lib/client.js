...
function ApplyPatchRow({ callId, block, openFile, inspect, t, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dsh-apply-patch-row", "data-tool": "apply_patch", "data-state": state, children: [status !== null && (0, jsx_runtime_1.jsx)("span", { className: "dsh-apply-patch-row__sr", children: status }), (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.DisclosureRow, { icon: stateLeading(state), title: "Apply patch", open: open, expandable: expandable, expandOnRowClick: true, keepContentWhenOpen: true, onToggle: () => { setExpanded(value => !value); }, rowClassName: "dsh-apply-patch-row__header", titleClassName: "dsh-apply-patch-row__title", collapsedContent: ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { className: "dsh-apply-patch-row__sep", "aria-hidden": true }), paths.length === 1 && state !== 'error' ? ((0, jsx_runtime_1.jsx)("button", { type: "button", className: "dsh-apply-patch-row__summary", onClick: openOnlyPath, children: summary })) : ((0, jsx_runtime_1.jsx)("span", { className: "dsh-apply-patch-row__summary", children: summary })), totals !== null && ((0, jsx_runtime_1.jsxs)("span", { className: "dsh-apply-patch-row__stat", children: ["+", totals.added, " -", totals.removed] }))] })), children: (0, jsx_runtime_1.jsxs)("div", { className: "dsh-apply-patch-row__body", children: [diffs !== null
                            ? (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.DiffBlock, { diffs: diffs, labels: labels, maxLines: 8, className: "dsh-apply-patch-row__diff" })
                            : output !== null && ((0, jsx_runtime_1.jsx)("div", { className: "dsh-apply-patch-row__output", "data-error": state === 'error', children: output })), inspect !== undefined && ((0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dsh-apply-patch-row__inspect", onClick: inspect, children: [(0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.IconInspectOutline12, {}), t('row.inspect')] }))] }) })] }));
}
