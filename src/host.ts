...
import { sandboxDenialMarker, writableRoots, type SandboxExecutionPolicy } from '@deepseek-ai/dsh-sandbox'
...
function policyFor(ctx: Context, exec: ToolRunContext): SandboxExecutionPolicy | undefined {
...
async function observeFinalState(ctx: Context, files: ApplyPatchResult['files'], cwd: string, exec: ToolRunContext): Promise<void> {
